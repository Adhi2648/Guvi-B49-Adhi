        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8 mt-3 text-center">
              <p>
                A collection or group of collections of books and/or other print
                or nonprint materials organized and maintained for use (reading,
                consultation, study, research, etc)!!!
              </p>
            </div>
          </div>
